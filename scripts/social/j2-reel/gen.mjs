...
const REPO = (process.env.REPO ?? process.cwd()).replace(/\/?$/, "/");
const OVERRIDES = REPO + "scripts/social/j2-reel/logo-overrides/";
...
<div id="stage">
  <div id="intro">
    ...
    <div class="ttl">
      ...
      <div class="m">Journée <b>${d.gameweek}</b></div>
  ...
  <div id="finale">
    ...
    <div class="ft">Journée <b>${d.gameweek}</b></div>
