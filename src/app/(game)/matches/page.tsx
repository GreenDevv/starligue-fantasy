...
export default async function MatchesPage({ searchParams }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-2xl text-text">Calendrier</h1>
      ...
      {/* Matches */}
      {!gameweek ? (
        <div className="py-8 text-center text-text-muted">Journée introuvable.</div>
      ...
      {gameweek && (
        <p className="text-center text-xs text-text-muted">
          Deadline : {gameweek.deadlineAt.toLocaleDateString("fr-FR", {
            day: "numeric",
            month: "long",
            hour: "2-digit",
            minute: "2-digit",
