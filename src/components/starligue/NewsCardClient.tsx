...
// Twin client de NewsCard.tsx (Server Component, next-intl/server) — dupliqué
// volontairement (même convention que PublicMobileMenu/MobileMenu) plutôt que
// généralisé : uniquement pour les actus chargées après coup par
// NewsFeedLoadMore.tsx, qui ne peut pas rendre un Server Component depuis un
// useState client. Garder les deux visuellement identiques si l'un des deux évolue.
export function NewsCardClient({ item }: { item: NewsFeedItem }) {
