...
// (src/app/(game)/leagues/[id]/page.tsx).
const NAV_ITEMS = [
  { href: "/dashboard", label: "Dashboard", Icon: DashboardIcon },
  { href: "/market", label: "Marché", Icon: MarketIcon },
  { href: "/predictions", label: "Pronos", Icon: TargetIcon },
  { href: "/leagues", label: "Ligues", Icon: LeaguesIcon },
  { href: "/leaderboard", label: "Classement", Icon: LeaderboardIcon },
  { href: "/matches", label: "Calendrier", Icon: CalendarIcon },
] as const;
